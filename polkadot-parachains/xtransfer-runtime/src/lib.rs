...
pub mod types;
use types::{TrustedReserve, ConvertedConcreteAssetId};
...
use xcm_builder::{
	AccountId32Aliases, FungiblesAdapter, AllowTopLevelPaidExecutionFrom, AllowUnpaidExecutionFrom, CurrencyAdapter,
	EnsureXcmOrigin, FixedWeightBounds, IsConcrete, LocationInverter, NativeAsset, Case,
...
pub type LocalAssetTransactor = FungiblesAdapter<
	Assets,
	ConvertedConcreteAssetId<u32, Balance, types::AsPrefixedGeneralIndex<Prefix, u32, types::SimpleAssetIdConverter<u32>>, types::SimpleBalanceConverter<Balance>>,
	LocationToAccountId,
	AccountId,
	All<u32>,
	(),
...
impl pallet_xtransfer::Config for Runtime {
	type Event = Event;
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		XTransfer: pallet_xtransfer::{Pallet, Call, Event<T>},
	}
);
